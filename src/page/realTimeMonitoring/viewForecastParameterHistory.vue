  ...
  <div>
    ...
    <div class="selectedLegend">
      <el-checkbox-group v-model="modelParamCheckedList" @change="_handleCheckedModelParamChange">
        <el-checkbox v-for="item in modelParamList" :label="item.name" :key="item.id"></el-checkbox>
      </el-checkbox-group>
    </div>
...
export default {
  ...
  methods: {
    ...
    _initForecastParameterHistoryEchartsByOutput () {
      ...
      this.forecastParameterHistory.option.legend.data = this.modelParamCheckedList;
